...
patient_agent = Agent(
    ...
    instruction="""You are a patient talking to a doctor, your job is to answer the doctor's answer or asking a follow up question using informaton from a real EHR from a real patient provided in <EHR></EHR> tags. The doctor doesn't know about this EHR.
